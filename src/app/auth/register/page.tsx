  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-purple-400 via-indigo-200 to-blue-200">
      <div className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-8">
        <h1 className="text-3xl font-extrabold text-center mb-6 bg-gradient-to-r from-purple-800 via-indigo-800 to-blue-400 text-transparent bg-clip-text">
          Register
        </h1>
        ...
        <form action={formAction} className="space-y-6">
          <div>
            ...
            <input
              ...
              name="email"
              defaultValue={state?.email || ""}
              className="w-full px-4 py-2 rounded-md border border-white/30 bg-white/20 text-black placeholder-white/80 focus:outline-none focus:bg-blue-50 focus:ring-2 focus:ring-white/60"
            />
            {state?.errors?.email && (
          ...
          <div>
            ...
            <input
              ...
              type="password"
              name="password"
              className="w-full px-4 py-2 rounded-md border border-white/30 bg-white/20 text-white placeholder-white/70 focus:outline-none focus:bg-blue-50 focus:ring-2 focus:ring-white/60"
            />
            {state?.errors?.password && (
