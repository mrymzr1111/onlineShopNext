...
// import { faBars, faTachometer, faUser, faEnvelope } from "@fortawesome/free-solid-svg-icons";
...
//         `}
//       >
//         <header className="flex justify-between items-center border-b border-gray-400 p-4 md:p-6 md:flex-col">
...
//         >
//           <div className="w-12 h-12 md:w-20 md:h-20 relative rounded-full overflow-hidden flex-shrink-0">
//             <Image
...
//             <span className="text-lg md:text-xl font-semibold">Fabian Olivares</span>
//           </div>
//         </div>
...
//               <Link
//                 href="/dashboard"
//                 className="flex items-center justify-center md:justify-start gap-2 p-4 text-white hover:bg-orange-800 w-full"
